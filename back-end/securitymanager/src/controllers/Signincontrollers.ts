...
export class Signincontroller {
    ...
    public sendOTP(req: Request, res: Response) {
        new CustomLogger().showLogger('info', 'Enter into Signincontrollers.ts: signup');
        signinservice.sendOTPservice(req, (response) => {
            res.status(201);
            res.json(response);
            new CustomLogger().showLogger('info', 'Exit from Signincontrollers.ts: signup');
        })
    ...
    public reSendOTP(req: Request, res: Response) {
        new CustomLogger().showLogger('info', 'Enter into Signincontrollers.ts: signup');
        signinservice.reSendOTPservice(req, (response) => {
            res.status(201);
            res.json(response);
            new CustomLogger().showLogger('info', 'Exit from Signincontrollers.ts: signup');
        })
    ...
    public verifyOTP(req: Request, res: Response) {
        new CustomLogger().showLogger('info', 'Enter into Signincontrollers.ts: signup');
        signinservice.verifyOTPservice(req, (response) => {
            res.status(201);
            res.json(response);
            new CustomLogger().showLogger('info', 'Exit from Signincontrollers.ts: signup');
        })
    ...
    public hashing(req: Request, res: Response) {
        new CustomLogger().showLogger('info', 'Enter into Signincontrollers.ts: signup');
        signinservice.hashing(req, (response) => {
            res.status(201);
            res.json(response);
            new CustomLogger().showLogger('info', 'Exit from Signincontrollers.ts: signup');
        })
